package com.ecosystem.mobile.reparation.ui.odata.viewmodel.attachment
...
class AttachmentODataViewModel(
    ...
    application,
    Z_API_SERVICE_ORDER_SRV_EntitiesMetadata.EntitySets.attachmentSet,
    orderByProperty,
    parent,
