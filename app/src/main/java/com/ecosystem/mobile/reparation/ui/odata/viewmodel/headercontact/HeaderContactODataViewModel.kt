package com.ecosystem.mobile.reparation.ui.odata.viewmodel.headercontact
...
class HeaderContactODataViewModel(
    ...
    application,
    Z_API_SERVICE_ORDER_SRV_EntitiesMetadata.EntitySets.headerContactSet,
    orderByProperty,
    parent,
