package com.ecosystem.mobile.reparation.ui.odata.viewmodel.headerquery
...
class HeaderQueryODataViewModel(
    ...
    application,
    Z_API_SERVICE_ORDER_SRV_EntitiesMetadata.EntitySets.headerQuerySet,
    orderByProperty,
    parent,
