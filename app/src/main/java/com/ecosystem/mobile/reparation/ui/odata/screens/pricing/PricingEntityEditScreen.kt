...
val PricingEntityEditScreen: @Composable (
    navigateUp: () -> Unit,
    ...
    val fieldStates = remember {
        listOf<FieldUIState>(
            FieldUIState(
                masterEntity.getOptionalValue(Pricing.stepNumber)?.toString() ?: "",
                Pricing.stepNumber,
                false
            ),
            FieldUIState(
                masterEntity.getOptionalValue(Pricing.counter)?.toString() ?: "",
                Pricing.counter,
                false
            ),
            FieldUIState(
                masterEntity.getOptionalValue(Pricing.application)?.toString() ?: "",
                Pricing.application,
                false
            ),
            FieldUIState(
                masterEntity.getOptionalValue(Pricing.conditionType)?.toString() ?: "",
                Pricing.conditionType,
                false
            ),
            FieldUIState(
                masterEntity.getOptionalValue(Pricing.amount)?.toString() ?: "",
                Pricing.amount,
                false
            ),
            FieldUIState(
                masterEntity.getOptionalValue(Pricing.currency)?.toString() ?: "",
                Pricing.currency,
                false
            ),
