...
val AttachmentEntityEditScreen: @Composable (
    navigateUp: () -> Unit,
    ...
    val fieldStates = remember {
        listOf<FieldUIState>(
            FieldUIState(
                masterEntity.getOptionalValue(Attachment.fileName)?.toString() ?: "",
                Attachment.fileName,
                false
            ),
            FieldUIState(
                masterEntity.getOptionalValue(Attachment.documentUrl)?.toString() ?: "",
                Attachment.documentUrl,
                false
            ),
            FieldUIState(
                masterEntity.getOptionalValue(Attachment.docType)?.toString() ?: "",
                Attachment.docType,
                false
            ),
