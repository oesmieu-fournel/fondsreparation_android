package com.ecosystem.mobile.reparation.ui.odata.viewmodel.partner
...
class PartnerODataViewModel(
    ...
    application,
    Z_API_SERVICE_ORDER_SRV_EntitiesMetadata.EntitySets.partnerSet,
    orderByProperty,
    parent,
